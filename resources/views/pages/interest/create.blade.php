            ...
            <form action="{{ route('interest.store') }}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="number" step="0.01" min="0" max="100" name="rate_percent" class="form-control @error('rate_percent') is-invalid @enderror" value="{{ old('rate_percent') }}" required placeholder="Contoh: 4.50">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="notes" class="form-control @error('notes') is-invalid @enderror" rows="3" placeholder="Contoh: SK Pengurus No. 12/2026 atau Kategori Khusus">{{ old('notes') }}</textarea>
                ...
                <div class="card-footer">
                    ...
                    <button type="submit" class="btn btn-primary float-right">
                        <i class="fas fa-save mr-1"></i> Simpan Rate Baru
                    </button>
                </div>
            </form>
        </div>
