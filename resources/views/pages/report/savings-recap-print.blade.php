...
<head>
    ...
    <style>
        ...
        * {
        ...
        .badge-danger { background-color: #ffe5e5; color: #000; border: 0.5px solid #000; }
...
<body>
    ...
    <div style="text-align: center; margin-bottom: 8px;">
        <div style="font-size: 14px; font-weight: bold; text-transform: uppercase; color: #000;">REKAP SIMPANAN NASABAH</div>
