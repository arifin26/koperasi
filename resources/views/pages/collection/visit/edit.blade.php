                    ...
                    <div class="card-body">
                        <form action="{{ route('collection.visit.update', $visit) }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" max="{{ date('Y-m-d') }}" value="{{ old('created_at', date('Y-m-d', strtotime($visit->created_at))) }}" class="form-control @error('created_at') is-invalid @enderror" name="created_at" readonly placeholder="Tanggal Kunjungan">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control @error('description') is-invalid @enderror" placeholder="Keterangan" rows="4">{{ old('description', $visit->description) }}</textarea>
