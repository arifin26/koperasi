            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col">
                                <a href="{{ route('collection.foreclosure.create') }}" class="btn btn-success">Baru</a>
    ...
    <div class="modal fade" id="print" tabindex="-1" aria-labelledby="printLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('collection.foreclosure.print') }}" method="post">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label>Sejak</label>
                                    <input required type="date" class="form-control" name="time_from" placeholder="Sejak">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label>Hingga</label>
                                    <input required type="date" class="form-control" name="time_to" placeholder="Sejak">
                                </div>
                            </div>
                        </div>
