                    ...
                    <div class="card-body">
                        <form action="{{ route('collection.foreclosure.update', $foreclosure) }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" min="0" class="form-control @error('return_amount') is-invalid @enderror" name="return_amount" value="{{ old('return_amount', $foreclosure->return_amount) }}" placeholder="Pengembalian">
